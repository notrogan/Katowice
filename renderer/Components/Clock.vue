	...
	<div class="clock">
		<div :class="['time', {
			...
			<template v-else-if="map.phase === 'live' || map.phase === 'intermission'">
				<div class="images" v-if="['bomb', 'defuse'].includes(timers.phase)">
					...
					<!-- <div class="img --c4" v-html="image(require('../../img/bomb_c4_animation.mp4'))"/> -->
					<!-- <div class="img --c4" src="require(`../../img/bomb_c4_animation.mp4`)"></div> -->
						<!-- <video src="require(`../../img/bomb_c4_animation.mp4`)"/> -->
					<!-- </div> -->
		...
		<div class="round-no">
			<template v-if="map.round < 30">
				<div v-if="!['bomb', 'defuse'].includes(timers.phase)">
